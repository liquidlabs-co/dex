...
* `github.com/liquidlabs-co/dex/storage`: Interface definitions which the storage must implement. __NOTE:__ This package is not stable.
* `github.com/liquidlabs-co/dex/storage/conformance`: Conformance tests which storage implementations must pass.
...
[issues-transaction-tests]: https://github.com/liquidlabs-co/dex/issues/600
